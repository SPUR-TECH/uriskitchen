...
urlpatterns = [
    ...
    path('dessert-comment-update/<int:pk>/<int:id>', views.dessertCommentUpdateView.as_view(), name='dessert_comment_update'),
    path('dessert-comment-delete/<int:pk>/<int:id>', views.dessertCommentDeleteView.as_view(), name='dessert_comment_delete'),
    ...
    path('comment-update/<int:pk>/<int:id>', views.commentUpdateView.as_view(), name='comment_update'),
    path('comment-delete/<int:pk>/<int:id>', views.commentDeleteView.as_view(), name='comment_delete'),
